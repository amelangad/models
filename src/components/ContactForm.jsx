...
export default function ContactForm() {
    return (
        ...
        <div className ="w-full h-full bg-[#c2afd3] flex flex-col justify-center items-center ">
            ...
            <div className="relative lg:overflow-hidden lg:absolute lg:right-20 w-full md:w-3/4 lg:w-1/2 h-3/4 lg:h-1/2 flex justify-center items-start bg-[#f0eee3] rounded-[100px] md:rounded-tl-[100px]  md:rounded-tr-[350px] md:rounded-bl-[400px] md:rounded-br-[200px]">
    ...
    <form action="/" className="mt-10 absolute lg:left-1/3 lg:top-1/4">
