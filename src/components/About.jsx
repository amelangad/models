  ...
  return (
    <div className ="w-full h-screen flex flex-col-reverse lg:flex-row bg-[#c6ccb7]">
        <div className="w-full h-screen lg:w-2/3 flex flex-col justify-center items-center bg-[#c6ccb7]">
            <div className ="w-full lg:w-3/4 h-3/4  p-5 lg:p-20 text-20 bg-[#e7d2d2] lg:rounded-br-[70%] lg:rounded-bl-[30%] lg:rounded-tl-[50%] lg:rounded-tr-[30%] flex justify-center items-center shadow-xl text-lg font-thin leading-[2rem]">
